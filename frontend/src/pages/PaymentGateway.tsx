        ...
        >
          <div className="w-full pt-1">
            <div
              ...
              style={styles}
            >
              <i className="mdi mdi-credit-card-outline text-[30px] font-playwrite">AQ</i>
            </div>
          </div>
          <div className="mb-10">
          ...
          <div className="space-y-3 flex flex-col items-center justify-center">
            ...
            <div className="text-lg flex flex-wrap">Scan above QR using mobile phone</div>
          </div>
        </div>
        <button className=" w-[20rem] h-[3rem] bg-green-800 text-white rounded-sm hover:bg-green-900" onClick={clickHandler}>Continue</button>
      </div>
    </div>
    </>
  );
