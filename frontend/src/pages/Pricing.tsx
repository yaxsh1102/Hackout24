...
const Pricing: React.FC = () => {
  ...
  return (
    <>
      <Navbar></Navbar>
      <section className="bg-white overflow-x-hidden w-screen mb-[-3rem]">
        <div className="py-40 px-4 mx-auto max-w-screen-xl lg:py-40 lg:px-6 overflow-x-hidden">
          <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            <h2 className="mb-4 text-4xl tracking-wider font-extrabold text-gray-900 dark:text-black">
              PRICING PLANS
            </h2>
            <p className="mb-5 font-light text-gray-500 sm:text-2xl dark:text-black">
              Here at AgroQuality we focus on talent, technology, and potential
              which can unlock innovation value and drive economic growth.
            </p>
          </div>
          <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-[4rem] lg:space-y-0 ">
            {/* Pricing Card */}
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-[#2d6930] rounded-lg border border-gray-100 shadow xl:p-8  dark:text-white">
              ...
              <p className="font-light text-white sm:text-lg ">
                Best option for your next project.
              </p>
